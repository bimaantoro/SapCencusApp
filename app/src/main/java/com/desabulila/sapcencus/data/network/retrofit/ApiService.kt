package com.desabulila.sapcencus.data.network.retrofit

import com.desabulila.sapcencus.data.network.response.CommonResponse
import com.desabulila.sapcencus.data.network.response.DetailPendudukResponse
...
interface ApiService {
    ...
    fun getPendudukDetail(
        @Query("nik") nik: String
    ): Call<DetailPendudukResponse>
    ...
    fun createPenduduk(
        ...
        @Field("sex") jenisKelamin: String,
        @Field("agama_id") agama: String,
        @Field("tempatlahir") tempatLahir: String,
        @Field("tanggallahir") tanggalLahir: String,
        @Field("pekerjaan_id") pekerjaan: String,
        ...
        @Field("id_cluster") kelurahan: String,
        @Field("qKecamatan") kecamatan: String,
    ...
    @FormUrlEncoded
    @PUT("update_penduduk.php?api_key=87Y78GF78SHFDSHFU")
    fun updatePenduduk(
