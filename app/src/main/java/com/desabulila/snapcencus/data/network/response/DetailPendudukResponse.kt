package com.desabulila.snapcencus.data.network.response

import com.google.gson.annotations.SerializedName

data class DetailPendudukResponse(
    ...
    @field:SerializedName("id_sex")
    val idSex: String? = null,
